        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              >
                <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: "#F2EFE8", fontSize: "1.1rem" }}>
                  Nibbl
                </span>
              ...
              <div className="px-4 py-2">
                ...
                >
                  ...
                  <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.78rem", color: "#55534F" }}>
                ...
                <div className="flex gap-2 overflow-x-auto pb-1" style={{ scrollbarWidth: "none" }}>
                  {["All", "Street Food", "Cafés", "Cheap Eats", "Late Night"].map((f, i) => (
                    <div
                      ...
                      style={{
                        background: i === 0 ? "#FF5C28" : "rgba(255,255,255,0.05)",
                        border: i === 0 ? "none" : "1px solid rgba(255,255,255,0.08)",
                        fontFamily: "'DM Sans', sans-serif",
                        fontSize: "0.65rem",
                        fontWeight: i === 0 ? 600 : 400,
                        color: i === 0 ? "#fff" : "#8A8780",
                      }}
                    >
                      {f}
                    </div>
                ...
                {MOCK_SPOTS.map((spot, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{ background: "rgba(255,255,255,0.06)", fontSize: "1.2rem" }}
                    >
                      {spot.emoji}
                    </div>
                    <div className="flex-1 min-w-0">
                      <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600, color: "#F2EFE8", fontSize: "0.8rem" }}>
                        {spot.name}
                      </p>
                      <p style={{ fontFamily: "'DM Sans', sans-serif", color: "#55534F", fontSize: "0.67rem" }}>
                        {spot.type} · {spot.dist}
                      </p>
                    </div>
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <div className="flex items-center gap-0.5">
                        ...
                        <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.65rem", color: "#8A8780" }}>{spot.rating}</span>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: "#F2EFE8", fontSize: "0.78rem" }}>
                  Mood-matched
                </span>
              </div>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.62rem", color: "#8A8780", marginTop: 2 }}>
            ...
            <div className="mt-10 flex flex-col gap-5">
              {[
                ...
                >
                  ...
                  <div>
                    <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: "#F2EFE8", fontSize: "0.95rem" }}>
                      {item.label}
                    </p>
                    <p style={{ fontFamily: "'DM Sans', sans-serif", color: "#55534F", fontSize: "0.83rem", lineHeight: 1.5, marginTop: 2 }}>
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
